					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="17%">图书封面</td>
								<td align="center" width="17%">图书名称</td>
								<td align="center" width="17%">图书价格</td>
							...
							<c:forEach items="${bookList }" var="book" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">
										<img width="40" height="45" src="${pageContext.request.contextPath }/${book.bimage }">
									</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${book.bname }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${book.bprice }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									...
									<td align="center" style="HEIGHT: 22px">
										<a href="javascript:void(0);" onclick="delProduct('${book.bid}')"> 
